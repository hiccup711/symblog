 ...
 */
final class Version20230728075347 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments_files ADD CONSTRAINT FK_4E03A73F93CB796C FOREIGN KEY (file_id) REFERENCES files (id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE comments_files DROP FOREIGN KEY FK_4E03A73FF8697D13');
